...
client.on('ready', async () => {
 ...
 client.user.setActivity(`Suspects v12 Ekonomi | Suspects!`, { type:'WATCHING' })
  
  console.log(`Suspects Ekonomi Botu || Suspects tarafından yapılmıştır, Paylaşılması Kesinlikle Yasaktır!!!`)
});
